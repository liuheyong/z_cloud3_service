...
public class ZCloud3ServiceApplication implements CommandLineRunner {

    public static final Logger logger = LoggerFactory.getLogger(ZCloud3ServiceApplication.class);
...
//    private String applicationName;
    ...
    public static void main(String[] args) throws InterruptedException {
        SpringApplication springApplication = new SpringApplication(ZCloud3ServiceApplication.class);
        //禁止命令行设置环境参数
